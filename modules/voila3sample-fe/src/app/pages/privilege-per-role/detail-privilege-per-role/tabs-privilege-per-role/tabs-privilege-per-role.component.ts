...
@Component({
    selector: 'app-tabs-privilege-per-role',
    templateUrl: './tabs-privilege-per-role.component.html',
    styleUrls: ['./tabs-privilege-per-role.component.scss']
})
export class TabsPrivilegePerRoleComponent implements OnChanges {
    ...
    @Input()
    public entity!: IPrivilegePerRole;
