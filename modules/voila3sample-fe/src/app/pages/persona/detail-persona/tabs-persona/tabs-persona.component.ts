...
@Component({
    selector: 'app-tabs-persona',
    templateUrl: './tabs-persona.component.html',
    styleUrls: ['./tabs-persona.component.scss']
})
export class TabsPersonaComponent implements OnChanges {
