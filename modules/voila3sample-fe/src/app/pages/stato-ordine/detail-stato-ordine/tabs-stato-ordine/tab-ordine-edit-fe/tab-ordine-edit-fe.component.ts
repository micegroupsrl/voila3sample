...
export class TabOrdineEditFeComponent extends BaseTabComponent implements OnInit, OnChanges {
    ...
    displayedColumns: string[] = ['idOrdine', 'descrizione', 'datetime', 'date', 'time', 'theTipoOrdineObjectKey', 'theClienteObjectKey', 'theOrdineAggregatoObjectKey', 'delete'];
    ...
    public ordineAggregatoList!: IStatoOrdine[];
  ...
  */
    ...
    createNewFormGroup(): FormGroup {
        return new FormGroup({
            ...
            theStatoOrdineObjectKey: new FormControl(this.entity?.objectKey!),
    ...
    loadData(pageObject: PageObject) {
        ...
        if (this.entity) {
            this.ordineApiService.getOrdineByStatoOrdine(this.entity?.objectKey!, options).subscribe(
                (data: any) => {
