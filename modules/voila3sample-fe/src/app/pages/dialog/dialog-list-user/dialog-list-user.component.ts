...
@Component({
    selector: 'app-dialog-list-user',
    templateUrl: './dialog-list-user.component.html',
    styleUrls: ['./dialog-list-user.component.scss']
})
export class DialogListUserComponent implements OnDestroy {
  private subscriptions = new Subscription();
    ...
    displayedColumns: string[] = ['userId', 'email', 'password', 'username'];
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogListUserComponent>,
    ...
    loadData(pageObject: PageObject) {
        ...
        this.apiService.getUser(options).subscribe(
            (data: any) => {
