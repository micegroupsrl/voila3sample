...
@Component({
    selector: 'app-dialog-list-privilege-per-role',
...
export class DialogListPrivilegePerRoleComponent {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogListPrivilegePerRoleComponent>,
    ...
    loadData(pageObject: PageObject) {
        ...
        this.apiService.getPrivilegePerRole(options).subscribe(
            (data: any) => {
