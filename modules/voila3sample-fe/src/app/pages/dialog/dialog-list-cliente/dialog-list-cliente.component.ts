...
export class DialogListClienteComponent implements OnDestroy {
  private subscriptions = new Subscription();
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogListClienteComponent>,
    ...
    loadData(pageObject: PageObject) {
        ...
        this.apiService.getCliente(options).subscribe(
            (data: any) => {
