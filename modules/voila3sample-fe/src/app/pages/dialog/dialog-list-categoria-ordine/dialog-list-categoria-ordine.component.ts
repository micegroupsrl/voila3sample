...
@Component({
    selector: 'app-dialog-list-categoria-ordine',
...
export class DialogListCategoriaOrdineComponent {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogListCategoriaOrdineComponent>,
    ...
    loadData(pageObject: PageObject) {
        ...
        this.apiService.getCategoriaOrdine(options).subscribe(
            (data: any) => {
