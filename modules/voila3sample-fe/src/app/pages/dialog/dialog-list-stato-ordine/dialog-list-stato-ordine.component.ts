...
@Component({
    selector: 'app-dialog-list-stato-ordine',
    templateUrl: './dialog-list-stato-ordine.component.html',
    styleUrls: ['./dialog-list-stato-ordine.component.scss']
})
export class DialogListStatoOrdineComponent implements OnDestroy {
  private subscriptions = new Subscription();
    ...
    displayedColumns: string[] = ['idStatoOrdine', 'descrizione'];
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogListStatoOrdineComponent>,
    ...
    loadData(pageObject: PageObject) {
        ...
        this.apiService.getStatoOrdine(options).subscribe(
            (data: any) => {
