...
@Component({
    selector: 'app-dialog-list-fornitore',
    templateUrl: './dialog-list-fornitore.component.html',
    styleUrls: ['./dialog-list-fornitore.component.scss']
})
export class DialogListFornitoreComponent implements OnDestroy {
  private subscriptions = new Subscription();
    ...
    displayedColumns: string[] = ['idPersona.idPersona', 'idPersona.cf', 'piva', 'nome', 'cognome', 'email', 'telefono'];
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogListFornitoreComponent>,
    ...
    loadData(pageObject: PageObject) {
        ...
        this.apiService.getFornitore(options).subscribe(
            (data: any) => {
