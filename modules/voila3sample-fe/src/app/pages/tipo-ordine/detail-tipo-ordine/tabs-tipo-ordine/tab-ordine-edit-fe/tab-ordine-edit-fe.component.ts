...
export class TabOrdineEditFeComponent extends BaseTabComponent implements OnInit, OnChanges {
    ...
    displayedColumns: string[] = ['idOrdine', 'descrizione', 'datetime', 'date', 'time', 'theStatoOrdineObjectKey', 'theClienteObjectKey', 'theOrdineAggregatoObjectKey', 'delete'];
  ...
  */
    ...
    createNewFormGroup(): FormGroup {
        return new FormGroup({
            ...
            theTipoOrdineObjectKey: new FormControl(this.entity?.objectKey!),
