...
export class TabRolePerUserEditFeComponent extends BaseTabComponent implements OnInit, OnChanges, OnDestroy {
    isLoading = false;
    totalRows = 0;
    pageSize = 3;
    currentPage = 0;
    ...
    displayedColumns: string[] = ['theUserObjectKey', 'delete'];
  ...
  */
    ...
    createNewFormGroup(): FormGroup {
        return new FormGroup({
            ...
            theUserObjectKey: new FormControl(null),
