...
public class LiquibaseConfigurationBean {
  ...
  @Bean
  public CustomSpringLiquibase securityLiquibase(
  ...
  @Bean
  public CustomSpringLiquibase primaryLiquibase(
      @Qualifier("PrimaryDataSource") DataSource primaryDataSource) {
    return liquibase(primaryLiquibaseProperties(), primaryDataSource, true);
  }

  public CustomSpringLiquibase liquibase(
      LiquibaseProperties liquibaseProperties, DataSource datasource, boolean shouldRun) {
