...
@NamedEntityGraph(
    name = RolePerUser.DEFAULT_ENTITY_GRAPH,
    attributeNodes = {
      @NamedAttributeNode(RolePerUser_.THE_ROLE),
      @NamedAttributeNode(RolePerUser_.THE_USER)
    })
public class RolePerUser extends BaseEntity implements Serializable {
  ...
  @EmbeddedId private RolePerUserKey theRolePerUserKey = new RolePerUserKey();
