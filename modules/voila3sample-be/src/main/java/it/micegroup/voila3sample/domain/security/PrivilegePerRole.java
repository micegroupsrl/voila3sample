...
@NamedEntityGraph(name = PrivilegePerRole.DEFAULT_ENTITY_GRAPH, attributeNodes = {
		@NamedAttributeNode(PrivilegePerRole_.THE_ROLE), @NamedAttributeNode(PrivilegePerRole_.THE_PRIVILEGE) })
public class PrivilegePerRole extends BaseEntity implements Serializable {
	...
	@EmbeddedId
	private PrivilegePerRoleKey thePrivilegePerRoleKey = new PrivilegePerRoleKey();
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@ToString.Exclude
	@JoinColumn(name = "privilege_id", referencedColumnName = "privilege_id", nullable = false, insertable = false, updatable = false)
	@MapsId("privilegeId")
	...
	public boolean equals(Object o) {
		...
		return thePrivilegePerRoleKey != null && Objects.equals(thePrivilegePerRoleKey, that.thePrivilegePerRoleKey);
	}
