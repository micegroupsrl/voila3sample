...
public class CategoriaOrdine extends BaseEntity implements Serializable {
  ...
  // CHILDREN
  /** Collection of child entity TipoOrdine */
  ...
  public String getObjectKey() {
    ...
    objectKey.append(getIdCatOrdine());
  ...
  public boolean equals(Object o) {
    ...
    return idCatOrdine != null && Objects.equals(idCatOrdine, that.idCatOrdine);
  }

  /** Overrides hashCode method to compute hash code of CategoriaOrdine object */
  @Override
  public int hashCode() {
    return Objects.hash(idCatOrdine);
  }
}
