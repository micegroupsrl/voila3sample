...
public interface RolePerUserRepository extends BaseRepository<RolePerUser, RolePerUserKey> {
  ...
  /** Finds all RolePerUser following the specification in input and return them in a Page */
  ...
  /** Finds all RolePerUser that are children of the TheRole in input and return them in a Page */
  @EntityGraph(value = RolePerUser.DEFAULT_ENTITY_GRAPH)
  Page<RolePerUser> findByTheRole(Role parentEntity, Pageable pageable);

  /** Finds all RolePerUser that are children of the TheUser in input and return them in a Page */
  @EntityGraph(value = RolePerUser.DEFAULT_ENTITY_GRAPH)
